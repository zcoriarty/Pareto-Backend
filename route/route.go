...
import (
	...
	"github.com/zcoriarty/Pareto-Backend/docs"
	"github.com/zcoriarty/Pareto-Backend/magic"
	"github.com/zcoriarty/Pareto-Backend/mail"
	mw "github.com/zcoriarty/Pareto-Backend/middleware"
	"github.com/zcoriarty/Pareto-Backend/mobile"
	...
	"github.com/zcoriarty/Pareto-Backend/service"
...
func (s *Services) SetupV1Routes() {
	...
	{
		// docs.SwaggerInfo.Host = "paretocircles.com"
		docs.SwaggerInfo.Title = "Pareto"
		docs.SwaggerInfo.Description = "Broker that uses golang gin as webserver, and go-pg library for connecting with a PostgreSQL database"
