...
func NewMail(mc *config.MailConfig, sc *config.SiteConfig) *Mail {
	return &Mail{
		...
		FromName:    "Pareto",
		FromEmail:   "noreply@paretocircles.com",
	}
}
